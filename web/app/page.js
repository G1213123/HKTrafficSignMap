        ...
        <div className="hero-container">
            <div className="hero-content">
                ...
                <h1 className="hero-title">
                    Professional Directional Sign Design Tool
                </h1>
                <p className="hero-subtitle">
                    Create, customize, and export professional directional signs online. Built with Hong Kong <span className="tpdm-tooltip" data-tooltip="Transport Planning and Design Manual">TPDM</span> standards for precision and compliance.
                </p>
            ...
            <div className="hero-visual">
                    ...
                    <img src="/images/hero-preview.svg" alt="Traffic Sign Designer Preview" className="preview-image" onError={(e) => e.target.style.display='none'} />
