...
export const renderLayerData = async (typeName, data, { map, markersRef, activeLayersRef, showRawPoints = false, showTsAbvSymbols = false, elevationFilter = 'ALL', layerDataRef = null, isDarkMode = false }) => {
    ...
    if (pointRenderer) {
        await pointRenderer(map, typeName, points, markersRef, activeLayersRef, showRawPoints, { layerDataRef, isDarkMode, showTsAbvSymbols });
    }
