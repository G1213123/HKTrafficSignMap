...
const dictionaries = {
  zh: {
    ...
    'Map': '地圖',
    'Loading Map...': '正在載入地圖…',
    'Initializing map...': '初始化地圖…',
    'Data active': '已載入資料',
    'Data loading...': '正在載入資料...',
    'Zoom in to level {{zoom}}+ to load data': '縮放至第{{zoom}}層或以上以載入資料',
    ...
    'Web-Based': '網頁版',
    'Explore More': '探索更多', 
    'Browse the Additional Sign Index catalog or Traffic Aids Map to assist your design process.': '瀏覽額外的標誌索引目錄或交通輔助地圖以協助您的設計過程。',
    'Sign Index Catalog': '標誌索引目錄',
    'Traffic Aids Map': '交通輔助地圖',
    'A browsable catalog of standard signs with metadata and images.': '瀏覽標準標誌目錄，包含資料與圖片。',
    'Explore an interactive map of traffic aids for existing road conditions.': '探索交通輔助互動地圖以了解現有道路狀況。',
