      ...
      <section className="gallery-page" style={{ paddingTop: '120px' }}>
        <div className="container">
          <div className="page-header">
            ...
            <p className="muted" style={{ marginBottom: '0.2rem' }}>Browse, preview and download traffic signs and road markings artwork.</p>
            <p style={{ fontSize: '0.85rem', color: '#6c757d', margin: '0' }}>
              Data provided by <a href="https://portal.csdi.gov.hk/" target="_blank" rel="noreferrer" style={{ color: '#0056b3', textDecoration: 'underline' }}>HKSAR CSDI Portal</a>. <a href="#data-disclaimer" style={{ color: '#0056b3', textDecoration: 'underline', cursor: 'pointer' }}>View terms of use</a>.
            </p>
          </div>
          ...
          <div id="data-disclaimer" className="csdi-disclaimer" style={{ 
            ...
            <p style={{ marginBottom: '12px' }}>
              Traffic signs and road marking data used in this index are provided by the Government of the Hong Kong Special Administrative Region via the <a href="https://portal.csdi.gov.hk/" target="_blank" rel="noreferrer" style={{ color: '#0d6efd', textDecoration: 'underline' }}>Common Spatial Data Infrastructure (CSDI) Portal</a>.
            </p>
            <p style={{ margin: 0 }}>
